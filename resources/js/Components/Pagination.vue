<template>
    <div v-if="links && links.length > 3" class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
            ...
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <template v-for="(link, index) in links" :key="index">
                        ...
                        />
                        <span
                            v-else-if="!link.url && index > 0 && index < links.length - 1"
                            v-html="link.label"
