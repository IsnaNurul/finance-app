...
// tentukan type berdasarkan data yang masuk
const type = props.transaction.debit > 0 ? 'debit' : 'credit';

const form = useForm({
    date: props.transaction.date,
    chart_of_account_id: props.transaction.chart_of_account_id,
    description: props.transaction.description,
    type: type,
    debit: props.transaction.debit ?? 0,
    credit: props.transaction.credit ?? 0,
});
